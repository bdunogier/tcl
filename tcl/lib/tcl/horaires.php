...
class tclHoraires
{
    ...
    public function __construct( tclParamsHoraires $params )
    {
        $this->params = array();
...
class tclParamsHorairesL10 implements tclParamsHoraires
{
...
class tclparamsHorairesL88 implements tclParamsHoraires
{
    public function getParams()
    {
        $params = array();
